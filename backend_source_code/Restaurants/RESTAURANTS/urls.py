...
from payment.provider_views import (
    ...
    PaymentProviderEventsAPIView,
    PaymentProviderListAPIView,
    PaymentProviderPaymentOperationAPIView,
...
urlpatterns = [
    ...
    path('api/payment-providers/<str:provider>/status/', PaymentProviderStatusAPIView.as_view()),
    path('api/payment-providers/<str:provider>/events', PaymentProviderEventsAPIView.as_view()),
    path('api/payment-providers/<str:provider>/events/', PaymentProviderEventsAPIView.as_view()),
    path('api/payment-providers/<str:provider>/payments/<int:payment_id>/<str:operation>', PaymentProviderPaymentOperationAPIView.as_view()),
    path('api/payment-providers/<str:provider>/payments/<int:payment_id>/<str:operation>/', PaymentProviderPaymentOperationAPIView.as_view()),
    path('api/payment-providers/<str:provider>/webhook/<int:gateway_id>', PaymentProviderWebhookAPIView.as_view()),
    path('api/payment-providers/<str:provider>/webhook/<int:gateway_id>/', PaymentProviderWebhookAPIView.as_view()),
