...
MIDDLEWARE = [
    ...
    'item.middleware.ProductionMenuBootstrapMiddleware',
...
UPSELL_LLM_PROVIDER = env('UPSELL_LLM_PROVIDER', default='openrouter').strip().lower()
...
OPENROUTER_UPSELL_FAST_FREE_MODELS = env(
...
OPENROUTER_UPSELL_PREFER_LOW_LATENCY_MODELS = env.bool(
    'OPENROUTER_UPSELL_PREFER_LOW_LATENCY_MODELS',
    default=True,
)
...
OPENROUTER_UPSELL_BATCH_TIMEOUT_SECONDS = env.float(
    'OPENROUTER_UPSELL_BATCH_TIMEOUT_SECONDS',
    default=20.0,
)
OPENROUTER_UPSELL_BATCH_MAX_OUTPUT_TOKENS = env.int(
    'OPENROUTER_UPSELL_BATCH_MAX_OUTPUT_TOKENS',
    default=1400,
)
UPSELL_LLM_DECISION_CACHE_SECONDS = env.int('UPSELL_LLM_DECISION_CACHE_SECONDS', default=900)
UPSELL_LLM_PERSISTENT_CACHE_DAYS = env.int('UPSELL_LLM_PERSISTENT_CACHE_DAYS', default=7)
