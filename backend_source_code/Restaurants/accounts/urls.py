...
from .views import RegisterApiView,CustomTokenObtainPairView,LogoutApiView,SendOTPView, VerifyOTPView, ResetPasswordView,UserInfoAPIView,ProfileView,TestUserView,ChefStaffViewSet,HealthCheckView, CreateSuperAdminView, ForgotPasswordView, TokenResetPasswordView
...
urlpatterns = [
    ...
    path('reset-password-token/', TokenResetPasswordView.as_view(), name='reset-password-token'),
